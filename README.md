...
For the Hex Ark two-wheel base adaptation assessment, topic contract, bridge design, and staged validation checklist, see [docs/hex_ark_navigation_assessment.md](docs/hex_ark_navigation_assessment.md). For the complete Chinese technical flow, see [docs/hex_ark_navigation_technical_flow_cn.md](docs/hex_ark_navigation_technical_flow_cn.md).
